  ...
  const getNotes = async () => {
    const response = await fetch(`http://localhost:3000/api/notes/fetchallNotes`, {
      ...
      headers: {
        ...
        'authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..I7UvnLNTEroUZmgWgQe3Khqqucqu7vJtrU2Y2Iv2uHM'
      }
    });
